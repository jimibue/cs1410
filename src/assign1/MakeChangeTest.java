...
public class MakeChangeTest {
	...
	public static void main(String[] args) {
		...
		// Get input from user, which is a String... This program assumes that user inputs a number greater or equal to zero
		String changeInput= JOptionPane.showInputDialog("Please enter the amount of change you have");
