...
public class assing3backup {
	...
	public static void main(String[] args) {
		...
		//System.out.println(sumOfLogs(input));
		
		File f = new File("/Users/jcc/Desktop/test.txt");
	...
	/**
	 * This subroutine uses a Scanner to add up all of the doubles in a string 
	 * 
	 * @param stringOfDoubles a scanner object containing a string of doubles
	 * @return the sum of the string of double
	 */

	public static double sum (Scanner stringOfDoubles){
		
		double sum = 0;
		
		while(stringOfDoubles.hasNextDouble()){

			sum = sum + stringOfDoubles.nextDouble();
		}
		return sum;
	}
