...
public class MethodLibraryMenu {
	...
	public static void main(String [] args){
		...
		// if else statements below determine which of the four methods to perform based on user input
		...
		if(methodChoice ==1){
			...
			//test to see if numbered entered is even or odd and display result
			...
			//test to see if number is negative and display the results
